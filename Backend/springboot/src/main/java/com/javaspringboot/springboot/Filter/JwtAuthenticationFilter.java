package com.javaspringboot.springboot.Filter;
...
import com.javaspringboot.springboot.Service.JwtService ;
...
// In essence, the `JwtAuthFilter` intercepts requests, looks for Bearer tokens,
// validates them, and authenticates users if the token is valid. Requests
// without a valid Bearer token continue through the filter chain, while
// authenticated users gain access to protected resources.
